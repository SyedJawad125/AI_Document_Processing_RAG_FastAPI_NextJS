...
//                       <Badge color="#d4af37">{chatResult.mode || 'RAG'}</Badge>
//                       <Badge color="#3b82f6">{chatResult.chunks_used || 0} chunks</Badge>
...
//                   <div style={{ display: 'flex', gap: 12, marginBottom: 16 }}>
//                     <WhiteBtn loading={loading} loadText="Loading…" onClick={getDocumentReport} disabled={loading || !selectedDoc} style={{ flex: 1 }}>
//                       Get Report Data
//                     </WhiteBtn>
//                     <button
//                       className="btn-ghost"
...
//                       <div>
//                         <div className="font-mono" style={{ fontSize: '0.65rem', color: 'var(--text-muted)', marginBottom: 4 }}>Filename</div>
//                         <div>{docDetails.filename}</div>
//                       </div>
//                       <div>
//                         <div className="font-mono" style={{ fontSize: '0.65rem', color: 'var(--text-muted)', marginBottom: 4 }}>Size</div>
//                         <div>{fmt.bytes(docDetails.file_size_mb * 1024 * 1024)}</div>
//                       </div>
//                       <div>
//                         <div className="font-mono" style={{ fontSize: '0.65rem', color: 'var(--text-muted)', marginBottom: 4 }}>Pages</div>
//                         <div>{docDetails.page_count}</div>
//                       </div>
//                       <div>
//                         <div className="font-mono" style={{ fontSize: '0.65rem', color: 'var(--text-muted)', marginBottom: 4 }}>Status</div>
//                         <Badge color={docDetails.status === 'ready' ? '#10b981' : '#f59e0b'}>{docDetails.status}</Badge>
//                       </div>
//                       <div>
//                         <div className="font-mono" style={{ fontSize: '0.65rem', color: 'var(--text-muted)', marginBottom: 4 }}>Created</div>
//                         <div>{fmt.date(docDetails.created_at)}</div>
//                       </div>
//                     </div>
//                   </Card>
//                 )}
...
//                     <div style={{ background:'var(--surface-2)', padding: 20, borderRadius: 8, whiteSpace: 'pre-wrap', fontSize: '0.85rem', lineHeight: 1.6 }}>
